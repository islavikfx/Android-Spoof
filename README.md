...
#### This app works only with rooted devices and Android 8.1 - 17+. It allows you to reset the Advertising ID / Android ID, hide device properties, and delete any device apps.
